    ...
    MOCK_COUNSELLORS.forEach(c => {
      ...
      if (attendance === "Absent") {
        ...
        data.push({
          ...
          "Manual Dial": 0,
          "AI": 0,
          "FY 27": c.campaign === "FY27" ? 1 : 0,
          "CC/FT/Board": 0,
          "FY 26": c.campaign === "FY26" ? 1 : 0,
          ...
          "No. of days": Math.max(1, Math.round((new Date(dateStr) - new Date(c.joiningDate)) / (1000 * 60 * 60 * 24))),
          "Band": c.band
        });
        return;
      }
      ...
      data.push({
        ...
        "Talktime (In hours)": parseFloat((talktime / 3600).toFixed(4)),
        "Target": c.target,
        "Total admissions": totalAdmissions,
        "Shared admissions": sharedAdmissions,
        "Shared admissions Form Filled": 0,
        "Additional Adm": additionalAdmissions,
        "Penalty": 0,
        "Total Adm": totalAdmissions,
        "Total Adm(form Filled)": formFilled,
        "EMI Paid": emiPaid,
